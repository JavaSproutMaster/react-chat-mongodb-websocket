...
export default function ClientAgreement() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_BASE_URL}/admin/client-agreement`, {
            headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL}/admin/client-agreement/${agrId}`, formData, {
            headers: {
                'Authorization': `Bearer ` + localStorage.getItem('accessToken')
            },
        }).then(res => {
        ...
        <div className="relative md:ml-64 bg-default-skin">
            ...
            <div className="flex flex-wrap min600">
                <div className="w-full mb-12 xl:mb-0 px-4 padding-top80 gridstyle">
                    <h1 className='text-2xl text-black font-bold mb-3'>Client Agreement</h1>
                    <form className='mt-4 shadow-md p-4 rounded bg-white' onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            />
                            {/* <textarea id="Message" rows="10" onChange={(e) => setAgreement(e.target.value)} defaultValue={agreement} className="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Agreement Details'></textarea> */}
                        </div>
                        <div className='flex'>
